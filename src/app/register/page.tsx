          ...
          <div className="grid grid-cols-3 gap-4 ">
            ...
            <div className="col-span-1 flex items-center justify-center">
              <div className="grid grid-rows-6">
                ...
                <div className="row-span-1 ">
                  <div style={{ color: "#a6a6a6" }}>Gender*</div>
                  <div>
                    {/* <input
                                            className="inputBox"
                                            type="gender"
                                        ...
                                        /> */}
                    <div className="">
                      <div style={{ color: "#a6a6a6" }} className="">
                        <input
                          type="radio"
                          className=""
                          name="gender"
                    ...
                    <div className="text-red-400 text-sm">{genderError}</div>
                  </div>
                </div>
                <div className="row-span-1 mt-4">
                  <div style={{ color: "#a6a6a6" }}>Date of Birth*</div>
                  <div>
                    <DatePicker
                      selected={dob}
                      ...
                      className="inputBox"
                    />
                    <div className="text-red-400 text-sm">{dobError}</div>
                  </div>
                </div>
